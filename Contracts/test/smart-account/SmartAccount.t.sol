...
contract SmartAccountTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory initData =
            abi.encodeWithSelector(SmartAccount.initialize.selector, owner, guardians, 1, entryPoint);
    ...
    function test_RecoveryHashComparison() public {
        ...
        // Cara contract
        bytes32 contractStyle = keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", innerHash));

...
contract TokenPaymasterTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory initData = abi.encodeWithSelector(
            TokenPaymaster.initialize.selector, address(token), entryPoint, address(priceFeed), address(this)
        );
        ...
        vm.mockCall(entryPoint, abi.encodeWithSignature("depositTo(address)", address(paymaster)), abi.encode());

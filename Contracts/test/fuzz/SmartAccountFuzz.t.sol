...
contract SmartAccountFuzz is Test {
    ...
    function setUp() public {
        ...
        bytes memory initData =
            abi.encodeWithSelector(SmartAccount.initialize.selector, owner, guardians, uint256(2), entryPoint);
     ...
     */
    function testFuzz_SequentialRecoveryAttack(address hackerNewOwner, uint256 maliciousIndex, bytes memory fakeSig)
        public
    {
